...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/dmanobela-glitch/bull4life-donate/blob/main/donate.ipynb)
...
```bash
curl -fsSL https://github.com/dmanobela-glitch/bull4life-donate/releases/download/v1.7.0/b4l_node-linux -o b4l_node
chmod +x b4l_node
